...
feature -- Fonction SDL2_ttf
	...
	frozen TTF_OpenFontIndex(filename:POINTER;taille:INTEGER;index:INTEGER_32):POINTER
		external
			"C (const char *,int,long):TTF_Font *| <SDL2_ttf.h>"
		alias
			"TTF_OpenFontIndex"
		end
	...
	frozen TTF_OpenFontIndexRW(rwop: POINTER; free_struct: INTEGER;taille:INTEGER;index:INTEGER_32):POINTER
		external
			"C (SDL_RWops *, int, int, long):TTF_Font *| <SDL2_ttf.h>"
		alias
			"TTF_OpenFontIndexRW"
		end
	...
	frozen TTF_FontFaceIsFixedWidth (font:POINTER):INTEGER
		external
			"C (const TTF_Font *) : int | <SDL2_ttf.h>"
		alias
	...
	frozen TTF_FontFaceFamilyName (font:POINTER):POINTER
		external
			"C (const TTF_Font *) : char * | <SDL2_ttf.h>"
		alias
	...
	frozen TTF_GlyphIsProvided (font:POINTER; ch: NATURAL_16):INTEGER
		external
			"C (const TTF_Font *, Uint16) : int | <SDL2_ttf.h>"
		alias
			"TTF_GlyphIsProvided "
		end
	...
	frozen TTF_GlyphMetrics (font:POINTER; ch: NATURAL_16; minx, maxx, miny, maxy, advance:POINTER):INTEGER
		external
			"C (const TTF_Font *, Uint16, int *, int *, int *, int *, int *) : int | <SDL2_ttf.h>"
		alias
			"TTF_GlyphMetrics "
		end
	...
	frozen TTF_SizeText (font, text, w, h:POINTER):INTEGER
		external
			"C (const TTF_Font *, const char *, int *, int *) : int | <SDL2_ttf.h>"
		alias
			"TTF_SizeText "
		end

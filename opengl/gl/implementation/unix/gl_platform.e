...
note
    description: "External for OpenGL library on Unix."
...
feature -- C external
	...
	frozen GL_MESA_packed_depth_stencil : NATURAL
		external
			"C [macro <GL/gl.h>] : unsigned int"
		alias
	...
	frozen GL_DEPTH_STENCIL_MESA : NATURAL
		external
			"C [macro <GL/gl.h>] : unsigned int"
		alias
	...
	frozen GL_UNSIGNED_INT_24_8_MESA : NATURAL
		external
			"C [macro <GL/gl.h>] : unsigned int"
		alias
	...
	frozen GL_UNSIGNED_INT_8_24_REV_MESA : NATURAL
		external
			"C [macro <GL/gl.h>] : unsigned int"
		alias
	...
	frozen GL_UNSIGNED_SHORT_15_1_MESA : NATURAL
		external
			"C [macro <GL/gl.h>] : unsigned int"
		alias
	...
	frozen GL_UNSIGNED_SHORT_1_15_REV_MESA : NATURAL
		external
			"C [macro <GL/gl.h>] : unsigned int"
		alias
	...
	frozen GL_OES_EGL_image : NATURAL
		external
			"C [macro <GL/gl.h>] : unsigned int"
		alias
			"GL_OES_EGL_image"
